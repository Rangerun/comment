...
func IsOrderHaveing(err error) bool {
	if err == nil {
		return false
	}
	e := errors.FromError(err)
	return e.Reason == ErrorReason_ORDER_HAVEING.String() && e.Code == 400
}

func ErrorOrderHaveing(format string, args ...interface{}) *errors.Error {
	return errors.New(400, ErrorReason_ORDER_HAVEING.String(), fmt.Sprintf(format, args...))
}
