...
func (x *ReplyReviewRequest) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
const file_api_review_v1_review_proto_rawDesc = "" +
	...
	"\breviewID\x18\x01 \x01(\x03R\breviewID\"\xde\x01\n" +
	...
	"\x0fListReviewReply2\x91\x04\n" +
	"\x06Review\x12k\n" +
	"\fCreateReview\x12\".api.review.v1.CreateReviewRequest\x1a .api.review.v1.CreateReviewReply\"\x15\x82\xd3\xe4\x93\x02\x0f:\x01*\"\n" +
	"/v1/review\x12Q\n" +
	"\vReplyReview\x12!.api.review.v1.ReplyReviewRequest\x1a\x1f.api.review.v1.ReplyReviewReply\x12T\n" +
